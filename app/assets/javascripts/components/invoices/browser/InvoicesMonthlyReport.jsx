...
class InvoicesMonthlyReport extends React.Component {
	...
	render() {
		...
		return (
			<span>
				<Button bsStyle="info" onClick={this.handleOpen}><span className="glyphicon glyphicon-list-alt"></span> Monthly Report</Button>
...
// property validators:
InvoicesMonthlyReport.propTypes = {
	year: React.PropTypes.number.isRequired,
	month: React.PropTypes.number.isRequired
};

export default InvoicesMonthlyReport